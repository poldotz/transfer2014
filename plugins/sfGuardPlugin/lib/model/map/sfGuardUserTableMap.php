...
class sfGuardUserTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('IP_ADDRESS', 'IpAddress', 'VARCHAR', false, 64, null);
        // validators
    } // initialize()
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Customer', 'Customer', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'SET NULL', null, 'Customers');
        $this->addRelation('Locality', 'Locality', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'SET NULL', null, 'Localitys');
        $this->addRelation('Arrival', 'Arrival', RelationMap::ONE_TO_MANY, array('id' => 'driver_id', ), 'SET NULL', 'CASCADE', 'Arrivals');
        $this->addRelation('Departure', 'Departure', RelationMap::ONE_TO_MANY, array('id' => 'driver_id', ), 'SET NULL', 'CASCADE', 'Departures');
    } // buildRelations()
