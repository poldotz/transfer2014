...
class sfGuardUserTableMap extends TableMap
{
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Locality', 'Locality', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null, 'Localitys');
        $this->addRelation('Arrival', 'Arrival', RelationMap::ONE_TO_MANY, array('id' => 'driver_id', ), 'SET NULL', 'CASCADE', 'Arrivals');
        $this->addRelation('Departure', 'Departure', RelationMap::ONE_TO_MANY, array('id' => 'driver_id', ), 'SET NULL', 'SET NULL', 'Departures');
    } // buildRelations()
