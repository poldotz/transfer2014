...
abstract class BasesfGuardPermissionPeer
{
     ...
     * e.g. sfGuardPermissionPeer::$fieldNames[sfGuardPermissionPeer::TYPE_PHPNAME][0] = 'Id'
     */
     ...
     *
     * first dimension keys are the type constants
     * e.g. sfGuardPermissionPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    ...
    {
        $toNames = sfGuardPermissionPeer::getFieldNames($toType);
        $key = isset(sfGuardPermissionPeer::$fieldKeys[$fromType][$name]) ? sfGuardPermissionPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(sfGuardPermissionPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, sfGuardPermissionPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return sfGuardPermissionPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(sfGuardPermissionPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(sfGuardPermissionPeer::DATABASE_NAME);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables(self::getMixerPreSelectHook(__FUNCTION__)) as $sf_hook)
        {
          call_user_func($sf_hook, 'BasesfGuardPermissionPeer', $criteria, $con);
     ...
     *
     * @param      sfGuardPermission $obj A sfGuardPermission object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            sfGuardPermissionPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(sfGuardPermissionPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(sfGuardPermissionPeer::$instances[$key])) {
                return sfGuardPermissionPeer::$instances[$key];
            }
        }
    ...
    {
        sfGuardPermissionPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(sfGuardPermissionPeer::DATABASE_NAME)->getTable(sfGuardPermissionPeer::TABLE_NAME);
    }
    ...
    {
        return sfGuardPermissionPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(sfGuardPermissionPeer::DATABASE_NAME);
