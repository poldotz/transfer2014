 ...
 * @method sfGuardUserQuery orderByPhone($order = Criteria::ASC) Order by the phone column
 ...
 * @method sfGuardUserQuery orderByIpAddress($order = Criteria::ASC) Order by the ip_address column
 *
 ...
 * @method sfGuardUserQuery groupByPhone() Group by the phone column
 ...
 * @method sfGuardUserQuery groupByIpAddress() Group by the ip_address column
 *
 ...
 *
 * @method sfGuardUserQuery leftJoinLocality($relationAlias = null) Adds a LEFT JOIN clause to the query using the Locality relation
 * @method sfGuardUserQuery rightJoinLocality($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Locality relation
 * @method sfGuardUserQuery innerJoinLocality($relationAlias = null) Adds a INNER JOIN clause to the query using the Locality relation
 *
 * @method sfGuardUserQuery leftJoinArrival($relationAlias = null) Adds a LEFT JOIN clause to the query using the Arrival relation
 * @method sfGuardUserQuery rightJoinArrival($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Arrival relation
 * @method sfGuardUserQuery innerJoinArrival($relationAlias = null) Adds a INNER JOIN clause to the query using the Arrival relation
 *
 * @method sfGuardUserQuery leftJoinDeparture($relationAlias = null) Adds a LEFT JOIN clause to the query using the Departure relation
 * @method sfGuardUserQuery rightJoinDeparture($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Departure relation
 * @method sfGuardUserQuery innerJoinDeparture($relationAlias = null) Adds a INNER JOIN clause to the query using the Departure relation
 *
 ...
 * @method sfGuardUser findOneByPhone(string $phone) Return the first sfGuardUser filtered by the phone column
 ...
 * @method sfGuardUser findOneByIpAddress(string $ip_address) Return the first sfGuardUser filtered by the ip_address column
 *
 ...
 * @method array findByPhone(string $phone) Return sfGuardUser objects filtered by the phone column
 ...
 * @method array findByIpAddress(string $ip_address) Return sfGuardUser objects filtered by the ip_address column
 *
...
abstract class BasesfGuardUserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `USERNAME`, `FIRST_NAME`, `LAST_NAME`, `EMAIL`, `PHONE`, `ALGORITHM`, `SALT`, `PASSWORD`, `CREATED_AT`, `LAST_LOGIN`, `IS_ACTIVE`, `IS_SUPER_ADMIN`, `IP_ADDRESS` FROM `sf_guard_user` WHERE `ID` = :p0';
        try {
    ...
    public function filterByPhone($phone = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(sfGuardUserPeer::PHONE, $phone, $comparison);
    }
    ...
    public function filterByIpAddress($ipAddress = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(sfGuardUserPeer::IP_ADDRESS, $ipAddress, $comparison);
    }
    ...
    public function filterByCustomer($customer, $comparison = null)
    {
        if ($customer instanceof Customer) {
            return $this
                ->addUsingAlias(sfGuardUserPeer::ID, $customer->getUserId(), $comparison);
    ...
    public function filterByLocality($locality, $comparison = null)
    {
        if ($locality instanceof Locality) {
            return $this
                ->addUsingAlias(sfGuardUserPeer::ID, $locality->getUserId(), $comparison);
     ...
     * @return sfGuardUserQuery The current query, for fluid interface
     */
    public function joinLocality($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     */
    public function useLocalityQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
    ...
    public function filterByArrival($arrival, $comparison = null)
    {
        if ($arrival instanceof Arrival) {
            return $this
                ->addUsingAlias(sfGuardUserPeer::ID, $arrival->getDriverId(), $comparison);
    ...
    public function filterByDeparture($departure, $comparison = null)
    {
        if ($departure instanceof Departure) {
            return $this
                ->addUsingAlias(sfGuardUserPeer::ID, $departure->getDriverId(), $comparison);
