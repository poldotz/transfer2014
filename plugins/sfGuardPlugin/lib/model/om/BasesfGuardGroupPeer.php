...
abstract class BasesfGuardGroupPeer
{
     ...
     * e.g. sfGuardGroupPeer::$fieldNames[sfGuardGroupPeer::TYPE_PHPNAME][0] = 'Id'
     */
     ...
     *
     * first dimension keys are the type constants
     * e.g. sfGuardGroupPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    ...
    {
        $toNames = sfGuardGroupPeer::getFieldNames($toType);
        $key = isset(sfGuardGroupPeer::$fieldKeys[$fromType][$name]) ? sfGuardGroupPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(sfGuardGroupPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, sfGuardGroupPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return sfGuardGroupPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(sfGuardGroupPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(sfGuardGroupPeer::DATABASE_NAME);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables(self::getMixerPreSelectHook(__FUNCTION__)) as $sf_hook)
        {
          call_user_func($sf_hook, 'BasesfGuardGroupPeer', $criteria, $con);
     ...
     *
     * @param      sfGuardGroup $obj A sfGuardGroup object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            sfGuardGroupPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(sfGuardGroupPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(sfGuardGroupPeer::$instances[$key])) {
                return sfGuardGroupPeer::$instances[$key];
            }
        }
    ...
    {
        sfGuardGroupPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(sfGuardGroupPeer::DATABASE_NAME)->getTable(sfGuardGroupPeer::TABLE_NAME);
    }
    ...
    {
        return sfGuardGroupPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(sfGuardGroupPeer::DATABASE_NAME);
