...
abstract class BasesfGuardUser extends BaseObject implements Persistent
{
    ...
    public function setIpAddress($v)
    {
        ...
        if ($this->ip_address !== $v) {
            $this->ip_address = $v;
            $this->modifiedColumns[] = sfGuardUserPeer::IP_ADDRESS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->algorithm = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            ...
            return $startcol + 14; // 14 = sfGuardUserPeer::NUM_HYDRATE_COLUMNS.
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->localitysScheduledForDeletion !== null) {
                if (!$this->localitysScheduledForDeletion->isEmpty()) {
                    foreach ($this->localitysScheduledForDeletion as $locality) {
                        // need to save related object because we set the relation to null
                        $locality->save($con);
                    }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(sfGuardUserPeer::FIRST_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`FIRST_NAME`';
        }
        if ($this->isColumnModified(sfGuardUserPeer::LAST_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`LAST_NAME`';
        }
        if ($this->isColumnModified(sfGuardUserPeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`EMAIL`';
        }
        if ($this->isColumnModified(sfGuardUserPeer::PHONE)) {
        ...
        if ($this->isColumnModified(sfGuardUserPeer::IP_ADDRESS)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) $this->setAlgorithm($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(sfGuardUserPeer::IP_ADDRESS)) $criteria->add(sfGuardUserPeer::IP_ADDRESS, $this->ip_address);
    ...
    public function setCustomers(PropelCollection $customers, PropelPDO $con = null)
    {
        ...
        foreach ($this->customersScheduledForDeletion as $customerRemoved) {
            $customerRemoved->setsfGuardUser(null);
        }
     ...
     * @return PropelObjectCollection|Customer[] List of Customer objects
     */
    public function getCustomersJoinCustomerType($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CustomerQuery::create(null, $criteria);
        $query->joinWith('CustomerType', $join_behavior);
    ...
    public function setLocalitys(PropelCollection $localitys, PropelPDO $con = null)
    {
        ...
        foreach ($this->localitysScheduledForDeletion as $localityRemoved) {
            $localityRemoved->setsfGuardUser(null);
        }
     ...
     * @return PropelObjectCollection|Locality[] List of Locality objects
     */
    public function getLocalitysJoinArea($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LocalityQuery::create(null, $criteria);
    ...
    public function setArrivals(PropelCollection $arrivals, PropelPDO $con = null)
    {
        ...
        foreach ($this->arrivalsScheduledForDeletion as $arrivalRemoved) {
            $arrivalRemoved->setsfGuardUser(null);
        }
    ...
    public function setDepartures(PropelCollection $departures, PropelPDO $con = null)
    {
        ...
        foreach ($this->departuresScheduledForDeletion as $departureRemoved) {
            $departureRemoved->setsfGuardUser(null);
        }
