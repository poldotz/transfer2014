 ...
 *
 * @method VehicleTypeQuery leftJoinCustomerRateTable($relationAlias = null) Adds a LEFT JOIN clause to the query using the CustomerRateTable relation
 * @method VehicleTypeQuery rightJoinCustomerRateTable($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CustomerRateTable relation
 * @method VehicleTypeQuery innerJoinCustomerRateTable($relationAlias = null) Adds a INNER JOIN clause to the query using the CustomerRateTable relation
 *
...
abstract class BaseVehicleTypeQuery extends ModelCriteria
{
    ...
    public function filterByCustomerRateTable($customerRateTable, $comparison = null)
    {
        if ($customerRateTable instanceof CustomerRateTable) {
            return $this
                ->addUsingAlias(VehicleTypePeer::ID, $customerRateTable->getVehicleTypeId(), $comparison);
