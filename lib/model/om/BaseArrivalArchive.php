...
abstract class BaseArrivalArchive extends BaseObject implements Persistent
{
    ...
    public function setRateCost($v)
    {
        ...
        if ($this->rate_cost !== $v) {
            $this->rate_cost = $v;
            $this->modifiedColumns[] = ArrivalArchivePeer::RATE_COST;
        }
    ...
    public function setCalculatedCost($v)
    {
        ...
        if ($this->calculated_cost !== $v) {
            ...
            $this->modifiedColumns[] = ArrivalArchivePeer::CALCULATED_COST;
        }
    ...
    public function setRateName($v)
    {
        ...
        if ($this->rate_name !== $v) {
            $this->rate_name = $v;
            $this->modifiedColumns[] = ArrivalArchivePeer::RATE_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 18; // 18 = ArrivalArchivePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ArrivalArchivePeer::RATE_COST)) {
            $modifiedColumns[':p' . $index++]  = '`RATE_COST`';
        }
        if ($this->isColumnModified(ArrivalArchivePeer::CALCULATED_COST)) {
            $modifiedColumns[':p' . $index++]  = '`CALCULATED_COST`';
        }
        if ($this->isColumnModified(ArrivalArchivePeer::RATE_NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArrivalArchivePeer::RATE_COST)) $criteria->add(ArrivalArchivePeer::RATE_COST, $this->rate_cost);
        if ($this->isColumnModified(ArrivalArchivePeer::CALCULATED_COST)) $criteria->add(ArrivalArchivePeer::CALCULATED_COST, $this->calculated_cost);
        if ($this->isColumnModified(ArrivalArchivePeer::RATE_NAME)) $criteria->add(ArrivalArchivePeer::RATE_NAME, $this->rate_name);
