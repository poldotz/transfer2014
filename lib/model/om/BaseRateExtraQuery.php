 ...
 * @method RateExtraQuery orderByTypology($order = Criteria::ASC) Order by the typology column
 *
 ...
 * @method RateExtraQuery groupByTypology() Group by the typology column
 *
 ...
 *
 * @method RateExtraQuery leftJoinCustomerRateExtra($relationAlias = null) Adds a LEFT JOIN clause to the query using the CustomerRateExtra relation
 * @method RateExtraQuery rightJoinCustomerRateExtra($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CustomerRateExtra relation
 * @method RateExtraQuery innerJoinCustomerRateExtra($relationAlias = null) Adds a INNER JOIN clause to the query using the CustomerRateExtra relation
 *
 ...
 * @method RateExtra findOneByValue(string $value) Return the first RateExtra filtered by the value column
 * @method RateExtra findOneByTypology(int $typology) Return the first RateExtra filtered by the typology column
 *
 ...
 * @method array findByValue(string $value) Return RateExtra objects filtered by the value column
 * @method array findByTypology(int $typology) Return RateExtra objects filtered by the typology column
 *
...
abstract class BaseRateExtraQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `NAME`, `VALUE`, `TYPOLOGY` FROM `rate_extra` WHERE `ID` = :p0';
        try {
    ...
    public function filterByTypology($typology = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RateExtraPeer::TYPOLOGY, $typology, $comparison);
    }
    ...
    public function filterByCustomerRateExtra($customerRateExtra, $comparison = null)
    {
        if ($customerRateExtra instanceof CustomerRateExtra) {
            return $this
                ->addUsingAlias(RateExtraPeer::ID, $customerRateExtra->getRateExtraId(), $comparison);
