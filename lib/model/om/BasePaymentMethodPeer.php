...
abstract class BasePaymentMethodPeer
{
     ...
     * e.g. PaymentMethodPeer::$fieldNames[PaymentMethodPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'IsActive', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'isActive', ),
        BasePeer::TYPE_COLNAME => array (PaymentMethodPeer::ID, PaymentMethodPeer::NAME, PaymentMethodPeer::IS_ACTIVE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'IS_ACTIVE', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. PaymentMethodPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'IsActive' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'isActive' => 2, ),
        BasePeer::TYPE_COLNAME => array (PaymentMethodPeer::ID => 0, PaymentMethodPeer::NAME => 1, PaymentMethodPeer::IS_ACTIVE => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'IS_ACTIVE' => 2, ),
    ...
    {
        $toNames = PaymentMethodPeer::getFieldNames($toType);
        $key = isset(PaymentMethodPeer::$fieldKeys[$fromType][$name]) ? PaymentMethodPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(PaymentMethodPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, PaymentMethodPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return PaymentMethodPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PaymentMethodPeer::DATABASE_NAME); // Set the correct dbName
        ...
        {
          call_user_func($sf_hook, 'BasePaymentMethodPeer', $criteria, $con);
        }
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PaymentMethodPeer::DATABASE_NAME);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables(self::getMixerPreSelectHook(__FUNCTION__)) as $sf_hook)
        {
          call_user_func($sf_hook, 'BasePaymentMethodPeer', $criteria, $con);
     ...
     *
     * @param      PaymentMethod $obj A PaymentMethod object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            PaymentMethodPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(PaymentMethodPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(PaymentMethodPeer::$instances[$key])) {
                return PaymentMethodPeer::$instances[$key];
            }
        }
    ...
    {
        PaymentMethodPeer::$instances = array();
    }
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = PaymentMethodPeer::getInstanceFromPool($key))) {
            ...
            $col = $startcol + PaymentMethodPeer::NUM_HYDRATE_COLUMNS;
        } else {
    ...
    {
        return Propel::getDatabaseMap(PaymentMethodPeer::DATABASE_NAME)->getTable(PaymentMethodPeer::TABLE_NAME);
    }
    ...
    {
        return PaymentMethodPeer::OM_CLASS;
    }
    ...
    /**
     * Performs an UPDATE on the database, given a PaymentMethod or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(PaymentMethodPeer::DATABASE_NAME);
    ...
    static private function getMixerPreSelectHook($method)
    {
      ...
      {
        return sprintf('BasePaymentMethodPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
      }
