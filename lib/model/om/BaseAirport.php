...
abstract class BaseAirport extends BaseObject implements Persistent
{
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = AirportPeer::CODE;
        }
    ...
    public function setLat($v)
    {
        ...
        if ($this->lat !== $v) {
            $this->lat = $v;
            $this->modifiedColumns[] = AirportPeer::LAT;
        }
    ...
    public function setLng($v)
    {
        ...
        if ($this->lng !== $v) {
            $this->lng = $v;
            $this->modifiedColumns[] = AirportPeer::LNG;
        }
    ...
    public function setTimezone($v)
    {
        ...
        if ($this->timezone !== $v) {
            $this->timezone = $v;
            $this->modifiedColumns[] = AirportPeer::TIMEZONE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->lat = ($row[$startcol + 5] !== null) ? (double) $row[$startcol + 5] : null;
            $this->lng = ($row[$startcol + 6] !== null) ? (double) $row[$startcol + 6] : null;
            ...
            return $startcol + 10; // 10 = AirportPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AirportPeer::CODE)) {
        ...
        if ($this->isColumnModified(AirportPeer::LAT)) {
            $modifiedColumns[':p' . $index++]  = '`LAT`';
        }
        if ($this->isColumnModified(AirportPeer::LNG)) {
            $modifiedColumns[':p' . $index++]  = '`LNG`';
        }
        if ($this->isColumnModified(AirportPeer::TIMEZONE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `airport` (%s) VALUES (%s)',
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) $this->setLng($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AirportPeer::CODE)) $criteria->add(AirportPeer::CODE, $this->code);
        ...
        if ($this->isColumnModified(AirportPeer::COUNTRY)) $criteria->add(AirportPeer::COUNTRY, $this->country);
        if ($this->isColumnModified(AirportPeer::LAT)) $criteria->add(AirportPeer::LAT, $this->lat);
        if ($this->isColumnModified(AirportPeer::LNG)) $criteria->add(AirportPeer::LNG, $this->lng);
        if ($this->isColumnModified(AirportPeer::TIMEZONE)) $criteria->add(AirportPeer::TIMEZONE, $this->timezone);
        if ($this->isColumnModified(AirportPeer::CREATED_AT)) $criteria->add(AirportPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(AirportPeer::UPDATED_AT)) $criteria->add(AirportPeer::UPDATED_AT, $this->updated_at);
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseAirport:' . $name))
        {
