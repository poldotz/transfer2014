...
abstract class BaseDepartureArchive extends BaseObject implements Persistent
{
    ...
    public function setCost($v)
    {
        ...
        if ($this->cost !== $v) {
            $this->cost = $v;
            $this->modifiedColumns[] = DepartureArchivePeer::COST;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 18; // 18 = DepartureArchivePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DepartureArchivePeer::COST)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DepartureArchivePeer::COST)) $criteria->add(DepartureArchivePeer::COST, $this->cost);
