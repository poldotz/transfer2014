...
abstract class BaseBookingQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `BOOKING_DATE`, `YEAR`, `NUMBER`, `ADULT`, `CHILD`, `CONTACT`, `RIF_FILE`, `CUSTOMER_ID`, `VEHICLE_TYPE_ID`, `IS_CONFIRMED`, `CREATED_AT`, `UPDATED_AT`, `VERSION`, `VERSION_CREATED_AT`, `VERSION_CREATED_BY` FROM `booking` WHERE `ID` = :p0';
        try {
    ...
    /**
     * Copy the data of the objects satisfying the query into BookingArchive archive objects.
