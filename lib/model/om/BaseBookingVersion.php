...
abstract class BaseBookingVersion extends BaseObject implements Persistent
{
    ...
    public function setReduced($v)
    {
        ...
        if ($this->reduced !== $v) {
            $this->reduced = $v;
            $this->modifiedColumns[] = BookingVersionPeer::REDUCED;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->arrival_ids = $row[$startcol + 17];
            $this->arrival_ids_unserialized = null;
            $this->arrival_versions = $row[$startcol + 18];
            $this->arrival_versions_unserialized = null;
            $this->departure_ids = $row[$startcol + 19];
            $this->departure_ids_unserialized = null;
            $this->departure_versions = $row[$startcol + 20];
            ...
            return $startcol + 21; // 21 = BookingVersionPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BookingVersionPeer::REDUCED)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[17] => $this->getArrivalIds(),
            $keys[18] => $this->getArrivalVersions(),
            $keys[19] => $this->getDepartureIds(),
            $keys[20] => $this->getDepartureVersions(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[17], $arr)) $this->setArrivalIds($arr[$keys[17]]);
        if (array_key_exists($keys[18], $arr)) $this->setArrivalVersions($arr[$keys[18]]);
        if (array_key_exists($keys[19], $arr)) $this->setDepartureIds($arr[$keys[19]]);
        if (array_key_exists($keys[20], $arr)) $this->setDepartureVersions($arr[$keys[20]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BookingVersionPeer::REDUCED)) $criteria->add(BookingVersionPeer::REDUCED, $this->reduced);
