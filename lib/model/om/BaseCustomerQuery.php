 ...
 * @method CustomerQuery orderByIsActive($order = Criteria::ASC) Order by the is_active column
 ...
 * @method CustomerQuery orderByLatitude($order = Criteria::ASC) Order by the latitude column
 * @method CustomerQuery orderByLongitude($order = Criteria::ASC) Order by the longitude column
 *
 * @method CustomerQuery groupById() Group by the id column
 * @method CustomerQuery groupByIsActive() Group by the is_active column
 ...
 * @method CustomerQuery groupByLatitude() Group by the latitude column
 * @method CustomerQuery groupByLongitude() Group by the longitude column
 *
 ...
 *
 * @method CustomerQuery leftJoinAreaVehicleRateTable($relationAlias = null) Adds a LEFT JOIN clause to the query using the AreaVehicleRateTable relation
 * @method CustomerQuery rightJoinAreaVehicleRateTable($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AreaVehicleRateTable relation
 * @method CustomerQuery innerJoinAreaVehicleRateTable($relationAlias = null) Adds a INNER JOIN clause to the query using the AreaVehicleRateTable relation
 *
 * @method CustomerQuery leftJoinCustomerRateExtra($relationAlias = null) Adds a LEFT JOIN clause to the query using the CustomerRateExtra relation
 * @method CustomerQuery rightJoinCustomerRateExtra($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CustomerRateExtra relation
 * @method CustomerQuery innerJoinCustomerRateExtra($relationAlias = null) Adds a INNER JOIN clause to the query using the CustomerRateExtra relation
 *
 * @method CustomerQuery leftJoinCustomerRate($relationAlias = null) Adds a LEFT JOIN clause to the query using the CustomerRate relation
 * @method CustomerQuery rightJoinCustomerRate($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CustomerRate relation
 * @method CustomerQuery innerJoinCustomerRate($relationAlias = null) Adds a INNER JOIN clause to the query using the CustomerRate relation
 *
 ...
 * @method Customer findOneByIsActive(boolean $is_active) Return the first Customer filtered by the is_active column
 ...
 * @method Customer findOneByLatitude(double $latitude) Return the first Customer filtered by the latitude column
 * @method Customer findOneByLongitude(double $longitude) Return the first Customer filtered by the longitude column
 *
 * @method array findById(int $id) Return Customer objects filtered by the id column
 * @method array findByIsActive(boolean $is_active) Return Customer objects filtered by the is_active column
 ...
 * @method array findByLatitude(double $latitude) Return Customer objects filtered by the latitude column
 * @method array findByLongitude(double $longitude) Return Customer objects filtered by the longitude column
 *
...
abstract class BaseCustomerQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `IS_ACTIVE`, `USER_ID`, `CUSTOMER_TYPE_ID`, `NAME`, `VAT_NUMBER`, `TAX_CODE`, `PHONE`, `FAX`, `MOBILE`, `EMAIL`, `SITE`, `FORMATTED_ADDRESS`, `IBAN`, `BIC`, `CREATED_AT`, `UPDATED_AT`, `LATITUDE`, `LONGITUDE` FROM `sf_guard_user_profile` WHERE `ID` = :p0';
        try {
    ...
    public function filterByIsActive($isActive = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CustomerPeer::IS_ACTIVE, $isActive, $comparison);
    }
    ...
    public function filterByLatitude($latitude = null, $comparison = null)
    {
        if (is_array($latitude)) {
            ...
            if (isset($latitude['min'])) {
                $this->addUsingAlias(CustomerPeer::LATITUDE, $latitude['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($latitude['max'])) {
                $this->addUsingAlias(CustomerPeer::LATITUDE, $latitude['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CustomerPeer::LATITUDE, $latitude, $comparison);
    }
    ...
    public function filterByLongitude($longitude = null, $comparison = null)
    {
        if (is_array($longitude)) {
            ...
            if (isset($longitude['min'])) {
                $this->addUsingAlias(CustomerPeer::LONGITUDE, $longitude['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($longitude['max'])) {
                $this->addUsingAlias(CustomerPeer::LONGITUDE, $longitude['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CustomerPeer::LONGITUDE, $longitude, $comparison);
    }
    ...
    public function filterByAreaVehicleRateTable($areaVehicleRateTable, $comparison = null)
    {
        if ($areaVehicleRateTable instanceof AreaVehicleRateTable) {
            return $this
                ->addUsingAlias(CustomerPeer::ID, $areaVehicleRateTable->getCustomerId(), $comparison);
    ...
    /**
     * Filter the query by a related CustomerRateExtra object
     *
     * @param   CustomerRateExtra|PropelObjectCollection $customerRateExtra  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   CustomerQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
     */
    public function filterByCustomerRateExtra($customerRateExtra, $comparison = null)
    {
        if ($customerRateExtra instanceof CustomerRateExtra) {
            return $this
                ->addUsingAlias(CustomerPeer::ID, $customerRateExtra->getCustomerId(), $comparison);
        } elseif ($customerRateExtra instanceof PropelObjectCollection) {
            return $this
                ->useCustomerRateExtraQuery()
                ->filterByPrimaryKeys($customerRateExtra->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCustomerRateExtra() only accepts arguments of type CustomerRateExtra or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CustomerRateExtra relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CustomerQuery The current query, for fluid interface
     */
    public function joinCustomerRateExtra($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CustomerRateExtra');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CustomerRateExtra');
        }
    ...
    /**
     * Use the CustomerRateExtra relation CustomerRateExtra object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CustomerRateExtraQuery A secondary query class using the current class as primary query
     */
    public function useCustomerRateExtraQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCustomerRateExtra($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CustomerRateExtra', 'CustomerRateExtraQuery');
    }
    ...
    public function filterByCustomerRate($customerRate, $comparison = null)
    {
        if ($customerRate instanceof CustomerRate) {
            return $this
                ->addUsingAlias(CustomerPeer::ID, $customerRate->getCustomerId(), $comparison);
     ...
     * @return CustomerQuery The current query, for fluid interface
     */
    public function withDistance($latitude, $longitude, $unit = CustomerPeer::KILOMETERS_UNIT)
    {
        ...
        $preparedSql = sprintf($sql,
            ...
            $this->getAliasedColName(CustomerPeer::LATITUDE),
            $this->getAliasedColName(CustomerPeer::LONGITUDE),
            deg2rad($longitude),
     ...
     * @return CustomerQuery The current query, for fluid interface
     */
    public function filterByDistanceFrom($latitude, $longitude, $distance, $unit = CustomerPeer::KILOMETERS_UNIT, $comparison = Criteria::LESS_THAN)
    {
        return $this
    ...
    /**
     * Filters objects near a given Customer object.
     *
     ...
     * @return CustomerQuery The current query, for fluid interface
     */
    public function filterNear(Customer $customer, $distance = 5, $unit = CustomerPeer::KILOMETERS_UNIT)
    {
        return $this
