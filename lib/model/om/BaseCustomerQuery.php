...
abstract class BaseCustomerQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `USER_ID`, `CUSTOMER_TYPE_ID`, `NAME`, `VAT_NUMBER`, `TAX_CODE`, `PHONE`, `FAX`, `MOBILE`, `EMAIL`, `SITE`, `FORMATTED_ADDRESS`, `IBAN`, `BIC`, `CREATED_AT`, `UPDATED_AT`, `LATITUDE`, `LONGITUDE` FROM `sf_guard_user_profile` WHERE `ID` = :p0';
        try {
