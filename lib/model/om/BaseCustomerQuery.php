 ...
 *
 * @method CustomerQuery leftJoinCustomerRateTable($relationAlias = null) Adds a LEFT JOIN clause to the query using the CustomerRateTable relation
 * @method CustomerQuery rightJoinCustomerRateTable($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CustomerRateTable relation
 * @method CustomerQuery innerJoinCustomerRateTable($relationAlias = null) Adds a INNER JOIN clause to the query using the CustomerRateTable relation
 *
...
abstract class BaseCustomerQuery extends ModelCriteria
{
    ...
    public function filterByCustomerRateTable($customerRateTable, $comparison = null)
    {
        if ($customerRateTable instanceof CustomerRateTable) {
            return $this
                ->addUsingAlias(CustomerPeer::ID, $customerRateTable->getCustomerId(), $comparison);
