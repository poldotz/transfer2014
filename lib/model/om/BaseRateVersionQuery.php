 ...
 * @method RateVersionQuery orderByPerPerson($order = Criteria::ASC) Order by the per_person column
 ...
 * @method RateVersionQuery orderByCustomerRateTableIds($order = Criteria::ASC) Order by the customer_rate_table_ids column
 * @method RateVersionQuery orderByCustomerRateTableVersions($order = Criteria::ASC) Order by the customer_rate_table_versions column
 *
 ...
 * @method RateVersionQuery groupByPerPerson() Group by the per_person column
 ...
 * @method RateVersionQuery groupByCustomerRateTableIds() Group by the customer_rate_table_ids column
 * @method RateVersionQuery groupByCustomerRateTableVersions() Group by the customer_rate_table_versions column
 *
 ...
 * @method RateVersion findOneByPerPerson(boolean $per_person) Return the first RateVersion filtered by the per_person column
 ...
 * @method RateVersion findOneByCustomerRateTableIds(array $customer_rate_table_ids) Return the first RateVersion filtered by the customer_rate_table_ids column
 * @method RateVersion findOneByCustomerRateTableVersions(array $customer_rate_table_versions) Return the first RateVersion filtered by the customer_rate_table_versions column
 *
 ...
 * @method array findByPerPerson(boolean $per_person) Return RateVersion objects filtered by the per_person column
 ...
 * @method array findByCustomerRateTableIds(array $customer_rate_table_ids) Return RateVersion objects filtered by the customer_rate_table_ids column
 * @method array findByCustomerRateTableVersions(array $customer_rate_table_versions) Return RateVersion objects filtered by the customer_rate_table_versions column
 *
...
abstract class BaseRateVersionQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `NAME`, `DESCRIPTION`, `DAY`, `HOUR_FROM`, `HOUR_TO`, `SURCHARGE`, `PER_PERSON`, `NOTE`, `CREATED_AT`, `UPDATED_AT`, `VERSION`, `VERSION_CREATED_AT`, `VERSION_CREATED_BY`, `CUSTOMER_RATE_TABLE_IDS`, `CUSTOMER_RATE_TABLE_VERSIONS` FROM `rate_version` WHERE `ID` = :p0 AND `VERSION` = :p1';
        try {
    ...
    public function filterByPerPerson($perPerson = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RateVersionPeer::PER_PERSON, $perPerson, $comparison);
    }
    ...
    /**
     * Filter the query on the customer_rate_table_ids column
     *
     * @param     array $customerRateTableIds The values to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return RateVersionQuery The current query, for fluid interface
     */
    public function filterByCustomerRateTableIds($customerRateTableIds = null, $comparison = null)
    {
        $key = $this->getAliasedColName(RateVersionPeer::CUSTOMER_RATE_TABLE_IDS);
        if (null === $comparison || $comparison == Criteria::CONTAINS_ALL) {
            foreach ($customerRateTableIds as $value) {
                $value = '%| ' . $value . ' |%';
        ...
        return $this->addUsingAlias(RateVersionPeer::CUSTOMER_RATE_TABLE_IDS, $customerRateTableIds, $comparison);
    }

    /**
     * Filter the query on the customer_rate_table_ids column
     * @param     mixed $customerRateTableIds The value to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::CONTAINS_ALL
     *
     * @return RateVersionQuery The current query, for fluid interface
     */
    public function filterByCustomerRateTableId($customerRateTableIds = null, $comparison = null)
    {
        if (null === $comparison || $comparison == Criteria::CONTAINS_ALL) {
            if (is_scalar($customerRateTableIds)) {
                $customerRateTableIds = '%| ' . $customerRateTableIds . ' |%';
                $comparison = Criteria::LIKE;
            }
        } elseif ($comparison == Criteria::CONTAINS_NONE) {
            $customerRateTableIds = '%| ' . $customerRateTableIds . ' |%';
            ...
            $key = $this->getAliasedColName(RateVersionPeer::CUSTOMER_RATE_TABLE_IDS);
            if ($this->containsKey($key)) {
                $this->addAnd($key, $customerRateTableIds, $comparison);
            } else {
                $this->addAnd($key, $customerRateTableIds, $comparison);
            }
            $this->addOr($key, null, Criteria::ISNULL);
    ...
    /**
     * Filter the query on the customer_rate_table_versions column
     *
     * @param     array $customerRateTableVersions The values to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return RateVersionQuery The current query, for fluid interface
     */
    public function filterByCustomerRateTableVersions($customerRateTableVersions = null, $comparison = null)
    {
        $key = $this->getAliasedColName(RateVersionPeer::CUSTOMER_RATE_TABLE_VERSIONS);
        if (null === $comparison || $comparison == Criteria::CONTAINS_ALL) {
            foreach ($customerRateTableVersions as $value) {
                $value = '%| ' . $value . ' |%';
                if ($this->containsKey($key)) {
                    $this->addAnd($key, $value, Criteria::LIKE);
                } else {
        ...
        return $this->addUsingAlias(RateVersionPeer::CUSTOMER_RATE_TABLE_VERSIONS, $customerRateTableVersions, $comparison);
    }

    /**
     * Filter the query on the customer_rate_table_versions column
     * @param     mixed $customerRateTableVersions The value to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::CONTAINS_ALL
     *
     * @return RateVersionQuery The current query, for fluid interface
     */
    public function filterByCustomerRateTableVersion($customerRateTableVersions = null, $comparison = null)
    {
        if (null === $comparison || $comparison == Criteria::CONTAINS_ALL) {
            if (is_scalar($customerRateTableVersions)) {
                $customerRateTableVersions = '%| ' . $customerRateTableVersions . ' |%';
                $comparison = Criteria::LIKE;
            }
        } elseif ($comparison == Criteria::CONTAINS_NONE) {
            $customerRateTableVersions = '%| ' . $customerRateTableVersions . ' |%';
            ...
            $key = $this->getAliasedColName(RateVersionPeer::CUSTOMER_RATE_TABLE_VERSIONS);
            if ($this->containsKey($key)) {
                $this->addAnd($key, $customerRateTableVersions, $comparison);
            } else {
                $this->addAnd($key, $customerRateTableVersions, $comparison);
            }
            $this->addOr($key, null, Criteria::ISNULL);
