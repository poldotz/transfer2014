...
abstract class BaseCustomer extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->customer_type_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->name = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->vat_number = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->tax_code = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            ...
            $this->formatted_address = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->iban = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->bic = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->created_at = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->updated_at = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
            $this->latitude = ($row[$startcol + 16] !== null) ? (double) $row[$startcol + 16] : null;
            $this->longitude = ($row[$startcol + 17] !== null) ? (double) $row[$startcol + 17] : null;
            $this->resetModified();
            ...
            return $startcol + 18; // 18 = CustomerPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getCustomerTypeId(),
            $keys[3] => $this->getName(),
            $keys[4] => $this->getVatNumber(),
            $keys[5] => $this->getTaxCode(),
            $keys[6] => $this->getPhone(),
            $keys[7] => $this->getFax(),
            $keys[8] => $this->getMobile(),
            $keys[9] => $this->getEmail(),
            $keys[10] => $this->getSite(),
            $keys[11] => $this->getFormattedAddress(),
            $keys[12] => $this->getIban(),
            $keys[13] => $this->getBic(),
            $keys[14] => $this->getCreatedAt(),
            $keys[15] => $this->getUpdatedAt(),
            $keys[16] => $this->getLatitude(),
            $keys[17] => $this->getLongitude(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setCustomerTypeId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setName($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setVatNumber($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setTaxCode($arr[$keys[5]]);
        ...
        if (array_key_exists($keys[11], $arr)) $this->setFormattedAddress($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setIban($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setBic($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setCreatedAt($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setUpdatedAt($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setLatitude($arr[$keys[16]]);
        if (array_key_exists($keys[17], $arr)) $this->setLongitude($arr[$keys[17]]);
    }
