...
abstract class BaseCustomer extends BaseObject implements Persistent
{
    ...
    public function setCustomerRateTables(PropelCollection $customerRateTables, PropelPDO $con = null)
    {
        ...
        foreach ($this->customerRateTablesScheduledForDeletion as $customerRateTableRemoved) {
            $customerRateTableRemoved->setCustomer(null);
        }
    ...
    protected function doAddCustomerRateTable($customerRateTable)
    {
        ...
        $customerRateTable->setCustomer($this);
    }
    ...
    public function removeCustomerRateTable($customerRateTable)
    {
        if ($this->getCustomerRateTables()->contains($customerRateTable)) {
            ...
            $customerRateTable->setCustomer(null);
        }
    }
     ...
     * @return PropelObjectCollection|CustomerRateTable[] List of CustomerRateTable objects
     */
    public function getCustomerRateTablesJoinRate($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CustomerRateTableQuery::create(null, $criteria);
