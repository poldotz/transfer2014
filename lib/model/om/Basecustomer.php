...
abstract class Basecustomer extends BaseObject implements Persistent
{
    ...
    public function setLat($v)
    {
        ...
        if ($this->lat !== $v) {
            $this->lat = $v;
            $this->modifiedColumns[] = customerPeer::LAT;
        }
    ...
    public function setLon($v)
    {
        ...
        if ($this->lon !== $v) {
            $this->lon = $v;
            $this->modifiedColumns[] = customerPeer::LON;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->lat = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->lon = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->iban = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->bic = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(customerPeer::LAT)) {
            $modifiedColumns[':p' . $index++]  = '`LAT`';
        }
        if ($this->isColumnModified(customerPeer::LON)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[12], $arr)) $this->setLat($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setLon($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setIban($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setBic($arr[$keys[15]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(customerPeer::LAT)) $criteria->add(customerPeer::LAT, $this->lat);
        if ($this->isColumnModified(customerPeer::LON)) $criteria->add(customerPeer::LON, $this->lon);
