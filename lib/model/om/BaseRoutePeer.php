...
abstract class BaseRoutePeer
{
    ...
    const LOCALITY_FROM = 'route.LOCALITY_FROM';

    /** the column name for the LOCALITY_TO field */
    const LOCALITY_TO = 'route.LOCALITY_TO';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'LocalityFrom', 'LocalityTo', 'Duration', 'Distance', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'localityFrom', 'localityTo', 'duration', 'distance', ),
        BasePeer::TYPE_COLNAME => array (RoutePeer::ID, RoutePeer::LOCALITY_FROM, RoutePeer::LOCALITY_TO, RoutePeer::DURATION, RoutePeer::DISTANCE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'LOCALITY_FROM', 'LOCALITY_TO', 'DURATION', 'DISTANCE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'locality_from', 'locality_to', 'duration', 'distance', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'LocalityFrom' => 1, 'LocalityTo' => 2, 'Duration' => 3, 'Distance' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'localityFrom' => 1, 'localityTo' => 2, 'duration' => 3, 'distance' => 4, ),
        BasePeer::TYPE_COLNAME => array (RoutePeer::ID => 0, RoutePeer::LOCALITY_FROM => 1, RoutePeer::LOCALITY_TO => 2, RoutePeer::DURATION => 3, RoutePeer::DISTANCE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'LOCALITY_FROM' => 1, 'LOCALITY_TO' => 2, 'DURATION' => 3, 'DISTANCE' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'locality_from' => 1, 'locality_to' => 2, 'duration' => 3, 'distance' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(RoutePeer::LOCALITY_FROM);
            $criteria->addSelectColumn(RoutePeer::LOCALITY_TO);
            $criteria->addSelectColumn(RoutePeer::DURATION);
            $criteria->addSelectColumn(RoutePeer::DISTANCE);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        {
          call_user_func($sf_hook, 'BaseRoutePeer', $criteria, $con);
        }
    ...
    public static function doCountJoinLocalityRelatedByLocalityFrom(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(RoutePeer::LOCALITY_FROM, LocalityPeer::ID, $join_behavior);
    ...
    public static function doCountJoinLocalityRelatedByLocalityTo(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(RoutePeer::LOCALITY_TO, LocalityPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Route objects pre-filled with their Locality objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinLocalityRelatedByLocalityFrom(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Route) to $obj2 (Locality)
                $obj2->addRouteRelatedByLocalityFrom($obj1);
    ...
    public static function doSelectJoinLocalityRelatedByLocalityTo(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Route) to $obj2 (Locality)
                $obj2->addRouteRelatedByLocalityTo($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Route) to the collection in $obj2 (Locality)
                $obj2->addRouteRelatedByLocalityFrom($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Route) to the collection in $obj3 (Locality)
                $obj3->addRouteRelatedByLocalityTo($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Route objects pre-filled with all related objects except LocalityRelatedByLocalityFrom.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Route objects pre-filled with all related objects except LocalityRelatedByLocalityTo.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
      return array(array('locality_from', 'locality_to'));
    }
    ...
    static private function getMixerPreSelectHook($method)
    {
      ...
      {
        return sprintf('BaseRoutePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
      }
