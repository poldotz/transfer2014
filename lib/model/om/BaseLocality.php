...
abstract class BaseLocality extends BaseObject implements Persistent
{
    ...
    public function setAreaId($v)
    {
        ...
        if ($this->area_id !== $v) {
            $this->area_id = $v;
            $this->modifiedColumns[] = LocalityPeer::AREA_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 16; // 16 = LocalityPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LocalityPeer::AREA_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LocalityPeer::AREA_ID)) $criteria->add(LocalityPeer::AREA_ID, $this->area_id);
