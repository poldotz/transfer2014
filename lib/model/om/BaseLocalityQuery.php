 ...
 * @method LocalityQuery orderByAreaId($order = Criteria::ASC) Order by the area_id column
 ...
 * @method LocalityQuery groupByAreaId() Group by the area_id column
 ...
 *
 * @method LocalityQuery leftJoinArea($relationAlias = null) Adds a LEFT JOIN clause to the query using the Area relation
 * @method LocalityQuery rightJoinArea($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Area relation
 * @method LocalityQuery innerJoinArea($relationAlias = null) Adds a INNER JOIN clause to the query using the Area relation
 *
 ...
 * @method Locality findOneByAreaId(int $area_id) Return the first Locality filtered by the area_id column
 ...
 * @method array findByAreaId(int $area_id) Return Locality objects filtered by the area_id column
...
abstract class BaseLocalityQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `USER_ID`, `IS_VECTOR`, `IS_ACTIVE`, `NAME`, `PHONE`, `FAX`, `MOBILE`, `EMAIL`, `SITE`, `FORMATTED_ADDRESS`, `LATITUDE`, `LONGITUDE`, `AREA_ID`, `CREATED_AT`, `UPDATED_AT` FROM `locality` WHERE `ID` = :p0';
        try {
    ...
    public function filterByAreaId($areaId = null, $comparison = null)
    {
        if (is_array($areaId)) {
            $useMinMax = false;
            if (isset($areaId['min'])) {
                $this->addUsingAlias(LocalityPeer::AREA_ID, $areaId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($areaId['max'])) {
                $this->addUsingAlias(LocalityPeer::AREA_ID, $areaId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(LocalityPeer::AREA_ID, $areaId, $comparison);
    }
    ...
    public function filterByArea($area, $comparison = null)
    {
        if ($area instanceof Area) {
            return $this
                ->addUsingAlias(LocalityPeer::AREA_ID, $area->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(LocalityPeer::AREA_ID, $area->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
