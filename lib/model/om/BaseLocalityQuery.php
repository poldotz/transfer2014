...
abstract class BaseLocalityQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `USER_ID`, `IS_VECTOR`, `IS_ACTIVE`, `NAME`, `PHONE`, `FAX`, `MOBILE`, `EMAIL`, `SITE`, `FORMATTED_ADDRESS`, `LATITUDE`, `LONGITUDE`, `CREATED_AT`, `UPDATED_AT` FROM `locality` WHERE `ID` = :p0';
        try {
