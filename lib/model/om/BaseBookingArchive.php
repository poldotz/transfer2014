...
/**
 * Base class that represents a row from the 'booking_archive' table.
 *
 *
 *
 ...
 */
abstract class BaseBookingArchive extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'BookingArchivePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BookingArchivePeer
     */
    ...
    /**
     * Initializes internal state of BaseBookingArchive object.
     * @see        applyDefaults()
     */
     ...
     * @return BookingArchive The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BookingArchivePeer::ID;
        }
    ...
    public function setBookingDate($v)
    {
        ...
        if ($this->booking_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BookingArchivePeer::BOOKING_DATE;
            }
    ...
    public function setYear($v)
    {
        ...
        if ($this->year !== $v) {
            $this->year = $v;
            $this->modifiedColumns[] = BookingArchivePeer::YEAR;
        }
    ...
    public function setNumber($v)
    {
        ...
        if ($this->number !== $v) {
            $this->number = $v;
            $this->modifiedColumns[] = BookingArchivePeer::NUMBER;
        }
    ...
    public function setAdult($v)
    {
        ...
        if ($this->adult !== $v) {
            $this->adult = $v;
            $this->modifiedColumns[] = BookingArchivePeer::ADULT;
        }
    ...
    public function setChild($v)
    {
        ...
        if ($this->child !== $v) {
            $this->child = $v;
            $this->modifiedColumns[] = BookingArchivePeer::CHILD;
        }
    ...
    public function setContact($v)
    {
        ...
        if ($this->contact !== $v) {
            $this->contact = $v;
            $this->modifiedColumns[] = BookingArchivePeer::CONTACT;
        }
    ...
    public function setRifFile($v)
    {
        ...
        if ($this->rif_file !== $v) {
            $this->rif_file = $v;
            $this->modifiedColumns[] = BookingArchivePeer::RIF_FILE;
        }
    ...
    public function setCustomerId($v)
    {
        ...
        if ($this->customer_id !== $v) {
            $this->customer_id = $v;
            $this->modifiedColumns[] = BookingArchivePeer::CUSTOMER_ID;
        }
    ...
    public function setVehicleTypeId($v)
    {
        ...
        if ($this->vehicle_type_id !== $v) {
            ...
            $this->modifiedColumns[] = BookingArchivePeer::VEHICLE_TYPE_ID;
        }
    ...
    public function setIsConfirmed($v)
    {
        ...
        if ($this->is_confirmed !== $v) {
            $this->is_confirmed = $v;
            $this->modifiedColumns[] = BookingArchivePeer::IS_CONFIRMED;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BookingArchivePeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BookingArchivePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setArchivedAt($v)
    {
        ...
        if ($this->archived_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BookingArchivePeer::ARCHIVED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 14; // 14 = BookingArchivePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BookingArchive object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BookingArchivePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BookingArchiveQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseBookingArchive:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseBookingArchive:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseBookingArchive:save:pre') as $callable)
            {
            ...
            if ($this->isModified() && !$this->isColumnModified(BookingArchivePeer::UPDATED_AT))
            {
            ...
            if ($isInsert) {
                ...
                // symfony_timestampable behavior
                if (!$this->isColumnModified(BookingArchivePeer::CREATED_AT))
                {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseBookingArchive:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                BookingArchivePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BookingArchivePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(BookingArchivePeer::BOOKING_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`BOOKING_DATE`';
        }
        if ($this->isColumnModified(BookingArchivePeer::YEAR)) {
            $modifiedColumns[':p' . $index++]  = '`YEAR`';
        }
        if ($this->isColumnModified(BookingArchivePeer::NUMBER)) {
            $modifiedColumns[':p' . $index++]  = '`NUMBER`';
        }
        if ($this->isColumnModified(BookingArchivePeer::ADULT)) {
            $modifiedColumns[':p' . $index++]  = '`ADULT`';
        }
        if ($this->isColumnModified(BookingArchivePeer::CHILD)) {
            $modifiedColumns[':p' . $index++]  = '`CHILD`';
        }
        if ($this->isColumnModified(BookingArchivePeer::CONTACT)) {
            $modifiedColumns[':p' . $index++]  = '`CONTACT`';
        }
        if ($this->isColumnModified(BookingArchivePeer::RIF_FILE)) {
            $modifiedColumns[':p' . $index++]  = '`RIF_FILE`';
        }
        if ($this->isColumnModified(BookingArchivePeer::CUSTOMER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`CUSTOMER_ID`';
        }
        if ($this->isColumnModified(BookingArchivePeer::VEHICLE_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`VEHICLE_TYPE_ID`';
        }
        if ($this->isColumnModified(BookingArchivePeer::IS_CONFIRMED)) {
            $modifiedColumns[':p' . $index++]  = '`IS_CONFIRMED`';
        }
        if ($this->isColumnModified(BookingArchivePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_AT`';
        }
        if ($this->isColumnModified(BookingArchivePeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`UPDATED_AT`';
        }
        if ($this->isColumnModified(BookingArchivePeer::ARCHIVED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`ARCHIVED_AT`';
        }

        $sql = sprintf(
            'INSERT INTO `booking_archive` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BookingArchivePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BookingArchivePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BookingArchive'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BookingArchive'][$this->getPrimaryKey()] = true;
        $keys = BookingArchivePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BookingArchivePeer::ID)) $criteria->add(BookingArchivePeer::ID, $this->id);
        if ($this->isColumnModified(BookingArchivePeer::BOOKING_DATE)) $criteria->add(BookingArchivePeer::BOOKING_DATE, $this->booking_date);
        if ($this->isColumnModified(BookingArchivePeer::YEAR)) $criteria->add(BookingArchivePeer::YEAR, $this->year);
        if ($this->isColumnModified(BookingArchivePeer::NUMBER)) $criteria->add(BookingArchivePeer::NUMBER, $this->number);
        if ($this->isColumnModified(BookingArchivePeer::ADULT)) $criteria->add(BookingArchivePeer::ADULT, $this->adult);
        if ($this->isColumnModified(BookingArchivePeer::CHILD)) $criteria->add(BookingArchivePeer::CHILD, $this->child);
        if ($this->isColumnModified(BookingArchivePeer::CONTACT)) $criteria->add(BookingArchivePeer::CONTACT, $this->contact);
        if ($this->isColumnModified(BookingArchivePeer::RIF_FILE)) $criteria->add(BookingArchivePeer::RIF_FILE, $this->rif_file);
        if ($this->isColumnModified(BookingArchivePeer::CUSTOMER_ID)) $criteria->add(BookingArchivePeer::CUSTOMER_ID, $this->customer_id);
        if ($this->isColumnModified(BookingArchivePeer::VEHICLE_TYPE_ID)) $criteria->add(BookingArchivePeer::VEHICLE_TYPE_ID, $this->vehicle_type_id);
        if ($this->isColumnModified(BookingArchivePeer::IS_CONFIRMED)) $criteria->add(BookingArchivePeer::IS_CONFIRMED, $this->is_confirmed);
        if ($this->isColumnModified(BookingArchivePeer::CREATED_AT)) $criteria->add(BookingArchivePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(BookingArchivePeer::UPDATED_AT)) $criteria->add(BookingArchivePeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(BookingArchivePeer::ARCHIVED_AT)) $criteria->add(BookingArchivePeer::ARCHIVED_AT, $this->archived_at);
    ...
    {
        $criteria = new Criteria(BookingArchivePeer::DATABASE_NAME);
        $criteria->add(BookingArchivePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of BookingArchive (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BookingArchive Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BookingArchivePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BookingArchivePeer();
        }
    ...
    {
        return (string) $this->exportTo(BookingArchivePeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseBookingArchive:' . $name))
        {
