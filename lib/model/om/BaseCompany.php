...
abstract class BaseCompany extends BaseObject implements Persistent
{
    ...
    public function setLat($v)
    {
        ...
        if ($this->lat !== $v) {
            $this->lat = $v;
            $this->modifiedColumns[] = CompanyPeer::LAT;
        }
    ...
    public function setLon($v)
    {
        ...
        if ($this->lon !== $v) {
            $this->lon = $v;
            $this->modifiedColumns[] = CompanyPeer::LON;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->lat = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->lon = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CompanyPeer::LAT)) {
            $modifiedColumns[':p' . $index++]  = '`LAT`';
        }
        if ($this->isColumnModified(CompanyPeer::LON)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[9], $arr)) $this->setLat($arr[$keys[9]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CompanyPeer::LAT)) $criteria->add(CompanyPeer::LAT, $this->lat);
        if ($this->isColumnModified(CompanyPeer::LON)) $criteria->add(CompanyPeer::LON, $this->lon);
