 ...
 * up to version 1398530782.
 * Generated on 2014-04-26 18:46:22 by poldotz
 */
class PropelMigration_1398530782
{
...
ALTER TABLE `booking` CHANGE `conctact` `contact` VARCHAR(100);

ALTER TABLE `booking_version` CHANGE `conctact` `contact` VARCHAR(100);
...
ALTER TABLE `booking` CHANGE `contact` `conctact` VARCHAR(100);

ALTER TABLE `booking_version` CHANGE `contact` `conctact` VARCHAR(100);
