 ...
 * up to version 1417863030.
 * Generated on 2014-12-06 11:50:30 by poldotz
 */
class PropelMigration_1417863030
{
...
ALTER TABLE `area_vehicle_rate_table` CHANGE `cost` `cost` DECIMAL(10,2) DEFAULT 0.00 NOT NULL;

ALTER TABLE `rate_extra` CHANGE `value` `value` DECIMAL(10,2) DEFAULT 0.00 NOT NULL;
...
ALTER TABLE `rate_extra` CHANGE `value` `value` INTEGER(2) NOT NULL;
