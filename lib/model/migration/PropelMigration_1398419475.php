 ...
 * up to version 1398419475.
 * Generated on 2014-04-25 11:51:15 by poldotz
 */
class PropelMigration_1398419475
{
...
ALTER TABLE `arrival`
    ADD `cancelled` TINYINT(1) DEFAULT 0 AFTER `vehicle_id`;
...
ALTER TABLE `arrival` DROP `cancelled`;

ALTER TABLE `arrival_version` CHANGE `cost` `cost` DECIMAL;

ALTER TABLE `arrival_version` DROP `cancelled`;

ALTER TABLE `departure` CHANGE `cost` `cost` DECIMAL;

ALTER TABLE `departure` DROP `cancelled`;

ALTER TABLE `departure_version` CHANGE `cost` `cost` DECIMAL;

ALTER TABLE `departure_version` DROP `cancelled`;
