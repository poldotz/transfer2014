 ...
 * up to version 1398696132.
 * Generated on 2014-04-28 16:42:12 by poldotz
 */
class PropelMigration_1398696132
{
...
ALTER TABLE `booking` CHANGE `child` `child` INTEGER(4) NOT NULL;

ALTER TABLE `booking_version` CHANGE `child` `child` INTEGER(4) NOT NULL;
