 ...
 * up to version 1398777928.
 * Generated on 2014-04-29 15:25:28 by poldotz
 */
class PropelMigration_1398777928
{
...
ALTER TABLE `arrival` CHANGE `cost` `cost` DECIMAL(10,2);

ALTER TABLE `arrival_version` CHANGE `cost` `cost` DECIMAL(10,2);

ALTER TABLE `departure` CHANGE `cost` `cost` DECIMAL(10,2);

ALTER TABLE `departure` CHANGE `payment_method_id` `payment_method_id` INTEGER;

ALTER TABLE `departure_version` CHANGE `cost` `cost` DECIMAL(10,2);

ALTER TABLE `departure_version` CHANGE `payment_method_id` `payment_method_id` INTEGER;
...
ALTER TABLE `departure` CHANGE `payment_method_id` `payment_method_id` INTEGER NOT NULL;

ALTER TABLE `departure_version` CHANGE `cost` `cost` DECIMAL;

ALTER TABLE `departure_version` CHANGE `payment_method_id` `payment_method_id` INTEGER NOT NULL;
