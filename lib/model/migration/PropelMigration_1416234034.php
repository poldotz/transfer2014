 ...
 * up to version 1416234034.
 * Generated on 2014-11-17 15:20:34 by lpodda
 */
class PropelMigration_1416234034
{
...
ALTER TABLE `rate`
    ADD `reduced_percentage` INTEGER(2) AFTER `surcharge`;

ALTER TABLE `rate` DROP `per_person`;

ALTER TABLE `rate_version`
    ADD `reduced_percentage` INTEGER(2) AFTER `surcharge`;

ALTER TABLE `rate_version` DROP `per_person`;

ALTER TABLE `rate_version` DROP `customer_rate_table_ids`;

ALTER TABLE `rate_version` DROP `customer_rate_table_versions`;
...
ALTER TABLE `rate`
    ADD `per_person` TINYINT(1) DEFAULT 0 AFTER `surcharge`;

ALTER TABLE `rate` DROP `reduced_percentage`;
...
ALTER TABLE `rate_version` DROP `reduced_percentage`;
