 ...
 * up to version 1398676979.
 * Generated on 2014-04-28 11:22:59 by poldotz
 */
class PropelMigration_1398676979
{
...
ALTER TABLE `payment_method`
    ADD `is_active` TINYINT(1) DEFAULT 1 NOT NULL AFTER `name`;
...
ALTER TABLE `payment_method` DROP `is_active`;
