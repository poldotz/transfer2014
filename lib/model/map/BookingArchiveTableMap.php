...
/**
 * This class defines the structure of the 'booking_archive' table.
 *
 *
 ...
 */
class BookingArchiveTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lib.model.map.BookingArchiveTableMap';
    ...
    {
        // attributes
        $this->setName('booking_archive');
        $this->setPhpName('BookingArchive');
        $this->setClassname('BookingArchive');
