...
class VehicleTypeTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('PER_PERSON', 'PerPerson', 'BOOLEAN', true, 1, false);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('AreaVehicleRateTable', 'AreaVehicleRateTable', RelationMap::ONE_TO_MANY, array('id' => 'vehicle_type_id', ), null, null, 'AreaVehicleRateTables');
