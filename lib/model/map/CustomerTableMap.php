...
class CustomerTableMap extends TableMap
{
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('AreaVehicleRateTable', 'AreaVehicleRateTable', RelationMap::ONE_TO_MANY, array('id' => 'customer_id', ), null, null, 'AreaVehicleRateTables');
        $this->addRelation('CustomerRateExtra', 'CustomerRateExtra', RelationMap::ONE_TO_MANY, array('id' => 'customer_id', ), null, null, 'CustomerRateExtras');
        $this->addRelation('CustomerRate', 'CustomerRate', RelationMap::ONE_TO_MANY, array('id' => 'customer_id', ), null, null, 'CustomerRates');
