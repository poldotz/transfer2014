...
/**
 * This class defines the structure of the 'departure_archive' table.
 *
 *
 ...
 */
class DepartureArchiveTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lib.model.map.DepartureArchiveTableMap';
    ...
    {
        // attributes
        $this->setName('departure_archive');
        $this->setPhpName('DepartureArchive');
        $this->setClassname('DepartureArchive');
        ...
        $this->addColumn('CALCULATED_COST', 'CalculatedCost', 'DECIMAL', true, 10, 0);
