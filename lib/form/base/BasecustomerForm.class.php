...
abstract class BasecustomerForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'customer_type_id'  => new sfWidgetFormPropelChoice(array('model' => 'CustomerType', 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'customer_type_id'  => new sfValidatorPropelChoice(array('model' => 'CustomerType', 'column' => 'id')),
