...
/**
 * Departure form base class.
 *
 * @method Departure getObject() Returns the current form's model object
 *
 * @package    transfer
 * @subpackage form
 * @author     Poldotz
 */
abstract class BaseDepartureForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorPropelUnique(array('model' => 'Departure', 'column' => array('booking_id')))
    );

    $this->widgetSchema->setNameFormat('departure[%s]');
