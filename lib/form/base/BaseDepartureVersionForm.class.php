...
/**
 * DepartureVersion form base class.
 *
 * @method DepartureVersion getObject() Returns the current form's model object
 *
 * @package    transfer
 * @subpackage form
 * @author     Poldotz
 */
abstract class BaseDepartureVersionForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('departure_version[%s]');
